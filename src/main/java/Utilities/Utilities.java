...
public class Utilities {
    ...
    public static double[] SplitNormalDistribution(int number_of_splits, double min, double max) {

        double[] points = new double[number_of_splits ];
        double length = (max - min) / (number_of_splits + 1);
        points[0] = min + length;
