...
public class DistributedLearning {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env
                .addSource(new FlinkKafkaConsumer<>("vvittisAgrawal3M", new SimpleStringSchema(), properties).setStartFromEarliest())
        ...
        // partial_result.addSink(new FlinkKafkaProducer<>("clu02.softnet.tuc.gr:6667", "vvittis_visualize_topic_agrawal3",
