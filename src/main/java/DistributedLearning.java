...
public class DistributedLearning
{
    ...
    public static void main(String[] args) throws Exception
    {
                ...
                {   // Training 
                    ...
                    for (int i = 1; i <= number_of_hoeffding_trees; i++)
                    {
                        ...
                        if(valueOfPoisson > 0 )
                        {
                            ...
                            System.out.println("Instanceid "+instance_id+" did not go to HoeffdingTree: "+ i);
                        }
        ...
        partial_result.addSink(new FlinkKafkaProducer<>("clu02.softnet.tuc.gr:6667", "vvittis_visualize_topic12",
        ...
        public void flatMap(Tuple3<String, Integer, Integer> input_stream, Collector<Tuple6<Integer, Integer, Integer, Integer, Double, Integer>> collector) throws Exception
        {
            ...
            if (age_of_maturity.value() >= age_of_maturity_input)
            {
                if (purpose_id == 5)
                {
                    ...
                    "As each training example is presented ot our algorithm, for each base lmodel, choose the example K - Poisson(1) times and update the base model accordingly." */
